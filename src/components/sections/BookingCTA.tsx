  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Subtext description */}
        <p className="max-w-md font-body font-light text-cream/60 text-sm md:text-base leading-relaxed mt-2">
        ...
        <div className="mt-6 flex flex-col items-center gap-6 w-full">
          <Magnetic>
            ...
            >
              <span className="relative z-10">{siteConfig.bookingCTA}</span>
